...
export const templateNavItems: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    dropdown: [
      ...
      { label: "News Highlight", href: "/examples/news-highlight" },
      ...
      { label: "Flyer Library", href: "/examples/flyer-library" },
