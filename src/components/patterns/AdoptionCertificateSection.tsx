    ...
    <div className="doc-body adoption-certificate-doc">
      <style>{`
        ...
        .adoption-cert-promise {
          background: linear-gradient(90deg, var(--doc-primary-light, hsl(30, 55%, 97%)), #fff, var(--doc-primary-light, hsl(30, 55%, 97%)));
      ...
      <PrintPageHeader
        buttonLabel="Print Certificate"
        instructions="Print on Letter paper in landscape orientation."
      />
