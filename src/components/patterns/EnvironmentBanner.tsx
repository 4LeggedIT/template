...
const EnvironmentBanner = ({
  ...
  useEffect(() => {
    // Deliberately client-only: flips after mount so the SSR/prerendered markup
    // (which must render "not client yet") matches the first client render exactly,
    // then reveals the banner once localStorage is safe to read.
